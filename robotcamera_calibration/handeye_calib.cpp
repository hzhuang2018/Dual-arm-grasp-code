...
int main(int argc, char* argv[])
{
	...
	*/
	...
	string filename = "./handeye_calib/image_calib";
	int counter = 0;
	...
	ofstream write;
	write.open("./handeye_calib/robot_pose.txt");
	...
	if (atoi(argv[6]) == 2)
		robot_camera_calib.type = Robot::RobotCameraCalibration::ROBOT_CAMERA_TYPE::EYE_TO_HAND;
	robot_camera_calib.calib_camera("./handeye_calib/", cv::Size(6, 9), 0.05);
	robot_camera_calib.load_robot_poses("./handeye_calib/robot_pose.txt");
	robot_camera_calib.run_calib();
#endif
